...
fovx, fovy, focalLength, principalPoint, aspectRatio = cv.calibrationMatrixValues(camMatrix, (480,640), 0.0, 0.0)
...
print(f"Dist Coeffecient:{distCof}")

print(f"Camera Metrics:{camMatrix}")