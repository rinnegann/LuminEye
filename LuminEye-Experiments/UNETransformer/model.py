...
class UNETR_2D(nn.Module):
    def __init__(self, cf):
        ...
        self.cf = cf
        self.patchify = PatchEmbed(self.cf["image_size"],self.cf["patch_size"])
    ...
    def forward(self, inputs):
        ...
        z0 = inputs.reshape((batch, self.cf["num_channels"], self.cf["image_size"], self.cf["image_size"]))
