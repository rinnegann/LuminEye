...
class CFG:
    def __init__(self,n_fold = 5,seed = 101,train_bs = 32,debug=False):
        self.n_fold = n_fold
        self.seed = seed
...
IMAGES  = "/home/nipun/Documents/Uni_Malta/Datasets/ShortDatasetTesting/train_img"
MASKS  = "/home/nipun/Documents/Uni_Malta/Datasets/ShortDatasetTesting/train_masks"
...
def initialise_config(debug=False,train_bs=4):
    cfg = CFG(train_bs = train_bs,debug = debug)
    set_seed(cfg.seed)
    return cfg
...
model_urls = {
    "swinv2_tiny_window16_256": "input/swinv2_tiny_patch4_window8_256.pth",
    "swinv2_small_window8_256": "input/swinv2_small_patch4_window8_256.pth",
    "swinv2_small_window16_256": "input/swinv2_small_patch4_window16_256.pth",
    "swinv2_base_window16_256": "input/swinv2_base_patch4_window16_256.pth",
}
from re import X
import torch,timm
import torch.nn as nn
...
class WindowAttention(nn.Module):
    ...
    def forward(self, x, mask=None):
        ...
        new_x = torch.log(torch.tensor(1/0.01)).to("cuda")
        # print(f"Tensor Type:{new_x}")
        logit_scale = torch.clamp(self.logit_scale, max=new_x).exp()
...
if __name__ == "__main__":
    cfg = initialise_config(train_bs = 4)
    cfg.display()
    ...
    tnsr = torch.randn([1,3,256,256])
    tnsr = tnsr.to(cfg.device)
