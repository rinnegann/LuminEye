"""
This file is created to specifically to train MICHE 2 dataset
...
from utils import *
from dataset_classes import Iris
...
if __name__ == "__main__":
    ...
    sched = torch.optim.lr_scheduler.OneCycleLR(
        optimizer, max_lr, epochs=epoch, steps_per_epoch=len(train_batch)
    )
